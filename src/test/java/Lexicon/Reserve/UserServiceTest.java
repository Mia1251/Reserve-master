/*
 * package Lexicon.Reserve;
 * 
 * import org.junit.Before; import org.junit.Test; import org.mockito.Mock;
 * import org.mockito.Mockito; import
 * org.springframework.security.crypto.bcrypt.BCryptPasswordEncoder;
 * 
 * import Lexicon.Reserve.models.User; import
 * Lexicon.Reserve.repository.RoleRepository; import
 * Lexicon.Reserve.repository.UserRepository; import
 * Lexicon.Reserve.services.UserService;
 * 
 ...
 * mockBCryptPasswordEncoder); user = User.builder() .id(1) .name("Gustavo")
 * .lastName("Ponce") .email("test@test.com") .build();
 * 
